...
This project includes **Keystatic CMS** - a modern, Git-based content editor that makes managing your portfolio easy without touching code.
...
You can customize the portfolio content in two ways:
