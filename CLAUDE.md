...
This is an Astro-based portfolio website using Tailwind CSS 4.x and DaisyUI for styling. The project follows Astro's standard project structure with file-based routing.
...
The portfolio website includes the following sections and components:
...
This project uses **Keystatic** - a Git-based headless CMS that provides a visual content editor while keeping content as files in the repository.
